...
function Eyes() {
  ...
  return (
      <div className='eyes w-full h-screen overflow-hidden'>
          <div data-scroll data-scroll-speed="-.7" className='relative w-full h-full bg-cover bg-center  bg-[url("./Components/pro_back.svg")]'>
              <div className='absolute flex gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]'>
                  ...
                  <div className='flex items-center justify-center w-[12vw] h-[12vw] rounded-full bg-zinc-100'>
                      <div className='relative w-2/3 flex items-center justify-center h-2/3 rounded-full bg-zinc-900'>
                          <div style={{ transform: `translate(-50%, -50%) rotate(${rotate}deg)` }} className='line absolute w-full h-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]'>
                              <div className='w-4 h-4 rounded-full bg-zinc-100'></div>   
                          </div>
                      </div>
...
// bg-[url("./Components/pro_back.png")]